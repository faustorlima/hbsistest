...
namespace HBSISTest.MVC.Controllers
{
    public class ClientesController : Controller
    {
        ...
        {
            var clienteModelView = Mapper.Map<IEnumerable<Cliente>, IEnumerable<ClienteViewModel>>(_clienteAppService.ObterClientesEspeciais());
